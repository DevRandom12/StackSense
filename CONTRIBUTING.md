...
- **Externalize Strings**: Do not hardcode UI strings. Add them to `app/src/main/res/values/strings.xml`.

## 🏗️ Building the Project
- **Debug Build**: Run `./gradlew assembleDebug`. This works out-of-the-box and is what you should use for development.
- **Release Build**: Requires a signing key. Unless you have the project keys (reserved for maintainers), `assembleRelease` may not produce a signed APK. Note that CI will automatically build signed release APKs on the main branch.
